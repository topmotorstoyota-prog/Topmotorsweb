...
const SHIPMENT_LOCATIONS = [
  ...
  { match: /benhong/i, name: 'Бенхон зогсоол, БНХАУ', lat: 42.7481, lng: 112.6600,
    arrived: () => `Эрээнээс 295 км зайд байрлах Бенхон зогсоол дээр ирсэн`,
    departed: (d) => `${d}-нд Бенхон зогсоолоос хөдөлсөн` },
